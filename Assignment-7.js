...
let introduceTheActors = (actorArray)=>{
  ...
  for(let i = 0; i < actorArray.length; i++){
    array.push('Hi, I\'m ' + actorArray[i].name + ' and I was in ' + actorArray[i].movie + '.');
  }
  return array;
};
...
const goToSecondClass = (a) =>{
  return("Time to go to " + a["secondHour"] + " class!");
};
